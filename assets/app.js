...
// Tema, interações e busca
  ...
  function attachLanguagesPagination() {
    ...
    let pageSize = window.StudyDevData.languages.length; // Define pageSize para o total de linguagens
    let page = 1;
    ...
    function renderPage(reset = false) {
      ...
      btnMore.style.display = 'none'; // Oculta o botão "mostrar mais" permanentemente
    }
    ...
    // Remove o event listener do botão "mostrar mais" já que ele não será mais usado
  ...
  window.addEventListener('DOMContentLoaded', () => { attachHeaderSearch(); attachLanguagesPagination(); attachMenuToggle(); });
