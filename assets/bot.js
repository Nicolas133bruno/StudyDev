  ...
  function attachBotIfPresent() {
    ...
    btnFix.onclick = async () => {
      ...
      try {
        ...
        const aiFixedIsDifferent = fixed.trim() !== editor.value.trim();
        const localFixedIsDifferent = localFixed.trim() !== editor.value.trim();
        ...
        const localFixed = StudyBot.fix(editor.value, lang);
        const localFixedIsDifferent = localFixed.trim() !== editor.value.trim();
        outputEl.textContent = localFixedIsDifferent ? localFixed : editor.value;
        if (statusEl) {
